...
interface KeeperRegistryBaseInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class KeeperRegistryBaseInterface extends BaseContract {
  ...
  interface: KeeperRegistryBaseInterfaceInterface;
